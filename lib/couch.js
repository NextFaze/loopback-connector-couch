(function() {
  ...
  CouchConnector = (function() {
    ...
    CouchConnector.prototype.all = function(model, filter, callback) {
      var designName, id, key, params, propName, props, value, viewName, where, _i, _len, _ref, _ref1, _ref2, _ref3;
      debug('CouchDB all');
      debug(model);
      debug(filter);
      if (id = filter != null ? (_ref = filter.where) != null ? _ref.id : void 0 : void 0) {
        if (!(filter != null ? (_ref1 = filter.where) != null ? (_ref2 = _ref1.id) != null ? _ref2.inq : void 0 : void 0 : void 0)) {
          debug('...moving to findById from all');
          if (filter != null ? filter.include : void 0) {
            return this.findById(model, id, (function(_this) {
              return function(err, result) {
                if (err) {
                  return callback(err);
                }
                return _this._models[model].model.include(result, filter.include, function(err, _result) {
      ...
      return this._nanoReader.view(designName, viewName, params, (function(_this) {
        return function(err, body) {
          var doc, docs, i, maxDocsNum, orders, output, row, sorting, startDocsNum, _j, _len1;
          if (err) {
            return callback && callback(err);
          }
          docs = (function() {
          ...
          if (filter != null ? filter.include : void 0) {
            return _this._models[model].model.include(output, filter.include, callback);
          } else {
