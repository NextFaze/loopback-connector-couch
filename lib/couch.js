(function() {
  ...
  CouchConnector = (function() {
    ...
    CouchConnector.prototype.all = function(model, filter, callback) {
      var designName, id, key, params, propName, props, value, viewName, where, _i, _len, _ref, _ref1;
      debug('CouchDB all');
      debug(filter);
        ...
        if (filter != null ? filter.include : void 0) {
          return this.findById(model, id, (function(_this) {
            return function(err, result) {
              ...
              return _this._models[model].model.include(result, filter.include, callback);
            };
          })(this));
        } else {
          if (typeof id !== 'object') {
